...
this script:
  ...
  3. Runs :file:`examples/validation_subset2.jsonl` with substring-match scoring.
  4. Writes a per-run summary JSON to ``summary_ruler_submissions_trace/``.
...
MAX_NEW_TOKENS              = 64
DATA_PATH                   = "examples/validation_subset2.jsonl"
SUMMARY_DIR                 = "summary_ruler_submissions_trace"
